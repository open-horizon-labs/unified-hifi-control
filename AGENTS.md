...
- Use `/review` before commits and at natural pause points.
- Use `/dissent` before significant or one-way decisions.
- Use `/problem-space` when a defect or architectural concern repeats.
- Use `/salvage` when work has drifted or an approach has reversed repeatedly.
...
| `volume` | ✅ | ✅ | ✅ | ✅ | 🚧 #328 | 🚧 #465 | ✅ | ✅ |
| `search` | ✅ | ✅ | ⛔ | ⛔ | 🚧 #209 | 🚧 #462 | ✅ | 🚧 #462 |
| `play_by_query` | ✅ | ✅ | ⛔ | ⛔ | 🚧 #209 | 🚧 #462 | ✅ | 🚧 #462 |
| `play_by_ref` | 🚧 #396 | 🚧 #396 | 🚧 #396 | 🚧 #396 | 🚧 #209 | 🚧 #462 | ✅ | 🚧 #462 |
| `browse` | 🚧 #399 | 🚧 #402 | ⛔ | ⛔ | 🚧 #209 | 🚧 #462 | ✅ | 🚧 #462 |
| `queue_read` | 🚧 #400 | 🚧 #400 | 🚧 #392 | ⛔ | 🚧 #209 | 🚧 #462 | ✅ | 🚧 #462 |
...
| `saved_playlists` | 🚧 #399 | 🚧 #403 | ⛔ | ⛔ | 🚧 #209 | 🚧 #462 | ✅ | 🚧 #462 |
| `favorites` | 🚧 #399 | 🚧 #403 | 🚧 #392 | ⛔ | 🚧 #209 | 🚧 #462 | ✅ | 🚧 #462 |
...
- 🚧 **applemusic / `transport`** (#465) — the native iPhone companion path is implemented, but this capability remains pending signed physical-device validation of SystemMusicPlayer behavior.
...
- 🚧 **applemusic / `transport_skip`** (#465) — the native iPhone companion path is implemented, but this capability remains pending signed physical-device validation of SystemMusicPlayer behavior.
...
- 🚧 **applemusic / `volume`** (#465) — the native iPhone companion path is implemented, but this capability remains pending signed physical-device validation of SystemMusicPlayer behavior.
